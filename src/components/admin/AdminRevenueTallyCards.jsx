...
export default function AdminRevenueTallyCards() {
  ...
  const cards = [
    ...
    { label: 'Earnings Paid Out',      value: fmt(data.earnings_paid_total),    sub: `Pending: ${fmt(data.earnings_pending_total)}`,                    detail: `This month: ${fmt(data.earnings_paid_this_month)}`, color: 'from-amber-600/20', border: 'border-amber-600/30', icon: <DollarSign size={14} /> },
  ];
