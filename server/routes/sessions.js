...
router.post("/render", requireGeneratorTier, startRender);
...
router.post("/video/generate", requireGeneratorTier, startRender);
router.get("/video/status/:id", getRenderStatus);
