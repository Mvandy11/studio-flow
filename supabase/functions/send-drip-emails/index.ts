...
function buildEmail(num: number, name: string): string {
  ...
  <p>Your $25/month → <strong>$20 goes directly to the Prize Pool</strong>. 50 founding members × $20 = <strong>$1,000/month in prizes</strong>. Every single month.</p>
  ...
  <p>Hey ${name} — what most creators pay monthly: AI tools ~$20, streaming ~$25, community ~$10, courses ~$30. That's <strong>~$85/month</strong> for tools that don't talk to each other and don't pay you anything back.</p>
  ...
  <ul><li>🏆 First monthly contest drops June 15</li><li>🎓 First Creator Academy course goes live June 20</li><li>🎬 Community live stream event — date TBA</li></ul>
